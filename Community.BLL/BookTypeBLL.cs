...
namespace Community.BLL
{
   public class BookTypeBLL
   {
       ...
       public string GetBookTypeParam(BookType param)
       {
           StringBuilder sb = new StringBuilder();
           sb.AppendFormat("where 1=1 ");

           if (!string.IsNullOrEmpty(param.BookTypeName))
           {
               sb.AppendFormat(" and BookTypeName like '%{0}%' ", Utils.SqlSafe(param.BookTypeName));
           }
