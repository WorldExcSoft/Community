...
{
   public class EduMajorBLL
   {
        
       EduMajorDAL dal = new EduMajorDAL();
       ...
       public string GetEduMajorParam(EduMajor param)
       {
           StringBuilder sb = new StringBuilder();
           sb.AppendFormat("where 1=1 ");

           if (!string.IsNullOrEmpty(param.EduMajorName))
           {
               sb.AppendFormat(" and EduMajorName like '%{0}%' ", Utils.SqlSafe(param.EduMajorName));
           }
