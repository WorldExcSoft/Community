...
{
   public class EduSchoolBLL
   {
        
       EduSchoolDAL dal = new EduSchoolDAL();
       ...
       public string GetEduSchoolParam(EduSchool param)
       {
           StringBuilder sb = new StringBuilder();
           sb.AppendFormat("where 1=1 ");

           if (!string.IsNullOrEmpty(param.EduSchoolName))
           {
               sb.AppendFormat(" and EduSchoolName like '%{0}%' ", Utils.SqlSafe(param.EduSchoolName));
           }
