...
namespace Community.BLL
{
   public class ProductionBLL
   {
       ...
       ProductionDAL dal = new ProductionDAL();
       ...
       public string GetProductionParam(ProductionParam param)
       {

           StringBuilder sb = new StringBuilder();

           if (!string.IsNullOrEmpty(param.ProductionName))
           {
               sb.AppendFormat(" where ProductionName like '%{0}%' ", Utils.SqlSafe(param.ProductionName));
           }
