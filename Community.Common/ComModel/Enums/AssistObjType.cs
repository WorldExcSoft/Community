...
namespace Community.Common
{
    public class AssistObjType
    {
        ...
        public static Dictionary<int, string> Dictionary = new Dictionary<int, string>()
            {
                {0, "未知"},{1, "课程"},{2, "文章"},{3, "电子书"},{4, "展厅"},{5, "学习圈"}
            };
        ...
        public static List<SelectListItem> SelectListItems = new List<SelectListItem>()
            {
                ...
                new SelectListItem() {Text = Dictionary[1], Value = "3"},
                new SelectListItem() {Text = Dictionary[1], Value = "4"},
                new SelectListItem() {Text = Dictionary[1], Value = "5"}
            };
