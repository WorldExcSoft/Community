    ...
    public class ThemeItemDAL
    {
      ...
      #region 数据访问层基本方法
        ...
        public bool Change(ThemeItem model)
        {
            SqlParameter[] param = new SqlParameter[]
            {
                new SqlParameter ("@ThemeItemId",model.ThemeItemId),
                new SqlParameter ("@ThemeBaseItemId",model.ThemeBaseItemId),
                new SqlParameter ("@ThemeItemName",model.ThemeItemName),
                new SqlParameter ("@ThemeId",model.ThemeId),
                new SqlParameter ("@OrderIndex",model.OrderIndex),
           ...
           return DBHelper.ExecuteNonQuery("ThemeItem_Change",param);
        }
        ...
        public bool Delete(int Id)
        {
           ...
           return DBHelper.ExecuteNonQuery ("ThemeItem_Delete",param);
        }
        ...
        public bool DeleteByWhere(string WhereString)
        {
           ...
           return DBHelper.ExecuteNonQuery ("ThemeItem_DeleteByWhere",param);
        }
